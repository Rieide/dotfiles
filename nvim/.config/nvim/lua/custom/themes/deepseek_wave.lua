...
local function overrides(colors)
  ...
  return {
    ...
    WinBar = { fg = p.fg_dim, bg = p.black },
    WinBarNC = { fg = p.muted, bg = p.black },
    TabLine = { fg = p.muted, bg = p.ink },
    TabLineFill = { bg = p.black },
    TabLineSel = { fg = p.fg, bg = p.surface },
    ...
    TelescopeNormal = { fg = p.fg_dim, bg = p.surface },
    TelescopeBorder = { fg = p.divider, bg = p.surface },
    TelescopePromptNormal = { fg = p.fg, bg = p.overlay },
    TelescopePromptBorder = { fg = p.overlay, bg = p.overlay },
    TelescopePromptTitle = { fg = p.black, bg = p.blue },
    TelescopePreviewTitle = { fg = p.blue, bg = p.surface },
    TelescopeResultsTitle = { fg = p.muted, bg = p.surface },
    ...
    BufferLineBackground = { fg = p.muted, bg = p.ink },
    BufferLineBufferVisible = { fg = p.fg_dim, bg = p.base },
    BufferLineBufferSelected = { fg = p.fg, bg = p.black },
    BufferLineIndicatorSelected = { fg = p.blue, bg = p.black },
    BufferLineSeparator = { fg = p.black, bg = p.ink },
    BufferLineSeparatorVisible = { fg = p.black, bg = p.base },
    BufferLineSeparatorSelected = { fg = p.black, bg = p.black },
    BufferLineModified = { fg = p.yellow, bg = p.ink },
    BufferLineModifiedVisible = { fg = p.yellow, bg = p.base },
    BufferLineModifiedSelected = { fg = p.yellow, bg = p.black },
